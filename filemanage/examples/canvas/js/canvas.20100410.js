...
var DRAW = function(canvas) {
	...
	var _scroll, _mouseDownPoint, _startPoint;
	var _type = "", _radius = 10, _isMouseDown = false, _overlay = null;
	var _pen = {
		fillColor: "#333",
		fillAlpha: 0.5,
		strokeWidth: 2,
	...
	var _removeAllHandlers = function(){
		/*GENERIC.removeEvent(document, "click", _onClick);
		GENERIC.removeEvent(document, "dblclick", _onDoubleClick);
		GENERIC.removeEvent(document, "mousedown", _onMouseDown);
		GENERIC.removeEvent(document, "mousemove", _onMouseMove);
		GENERIC.removeEvent(document, "mouseup", _onMouseUp);*/
		document.onmclick = null;
		document.onmdblclick = null;
	...
	var _addMouseHandlers = function() {
		...
		GENERIC.addEvent(document, "mouseup", _onMouseUp);*/
	...
	var _ready = function(type, radius) {
		_type = type;
		...
		if (type == "polyline" || type == "polygon") {
			...
			document.ondblclick = _onDoubleClick;
		}
		//GENERIC.addEvent(document, "mousedown", _onMouseDown);
